...
Over the past year, the Greater Louisville Project published a series of reports in alignment with A Path Forward. The context of our work is described here in a letter from the Director of Community Engagement, Dr. Monica Unseld:
...
This document is not going to solve every problem facing Louisville. However, it is a road map for future opportunities. We chose projects and initiatives that would allow us to prove to funders and policy makers that we can take care of ourselves. In fact, we have been caring for ourselves for centuries. We have just always lacked money and power. 
...
In response to the A Path Forward document, GLP took the courageous step to align with this initiative, even moving beyond the original intent of GLP. We took a step to do the right thing. In that light, we produced 4 reports, on the topics of the digital divide, housing, early childhood education, and Black wealth. Along with each report, we held community conversations, where neighbors within the Black community could speak for themselves. The feedback from these conversations has been positive and we have seen ripples within the community to keep these conversations going. 
